...
public class Handover implements Parcelable
{
    ...
    public Handover(List<String> fuelAttachments, List<String> tireAttachments, List<String> speedometerAttachments, List<String> sideviewAttachments, List<String> frontpartAttachments, List<String> backpartAttachments) {
        super();
