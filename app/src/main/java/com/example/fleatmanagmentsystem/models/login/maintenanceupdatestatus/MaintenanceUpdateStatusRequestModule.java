...
public class MaintenanceUpdateStatusRequestModule implements Parcelable
{
    ...
    public final static Creator<MaintenanceUpdateStatusRequestModule> CREATOR = new Creator<MaintenanceUpdateStatusRequestModule>() {


        @SuppressWarnings({
                "unchecked"
        })
        public MaintenanceUpdateStatusRequestModule createFromParcel(android.os.Parcel in) {
            return new MaintenanceUpdateStatusRequestModule(in);
        }

        public MaintenanceUpdateStatusRequestModule[] newArray(int size) {
            return (new MaintenanceUpdateStatusRequestModule[size]);
        }

    }
            ;

    protected MaintenanceUpdateStatusRequestModule(android.os.Parcel in) {
